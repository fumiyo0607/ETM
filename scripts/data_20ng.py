...
# Stop words Num (max: 523)
stop_word_num = 523

# Read stopwords
stop_words_file = 'stops.txt'
with open(stop_words_file, 'r') as f:
    stops = f.read().split('\n')

random_stops = random.sample(stops, stop_word_num)
...
vocab_aux = [w for w in vocab_aux if w not in random_stops]
...
path_save = './max_df=' + str(max_df) + '-min_df=' + str(min_df) + '-stop_words_num=' + str(stop_word_num) + '/'
